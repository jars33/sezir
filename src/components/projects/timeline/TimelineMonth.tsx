        ...
        <div className={`space-y-2 w-full flex flex-col items-center ${!hasCosts ? 'flex-1' : ''}`}>
          {revenues.map((revenue) => (
            <div
              ...
              className="p-2 bg-green-50 border border-green-200 rounded text-sm cursor-pointer hover:bg-green-100 w-[95%] text-center"
            >
        ...
        <div className={`space-y-2 w-full flex flex-col items-center ${!hasRevenues ? 'flex-1' : ''}`}>
          {variableCosts.map((cost) => (
            <div
              ...
              className="p-2 bg-red-50 border border-red-200 rounded text-sm cursor-pointer hover:bg-red-100 w-[95%] text-center"
            >
          ...
          {overheadCosts.map((cost) => (
            <div
              ...
              className="p-2 bg-orange-50 border border-orange-200 rounded text-sm cursor-pointer hover:bg-orange-100 w-[95%] text-center"
            >
