    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-white">
        <div className="fixed left-0 top-0 h-full">
          <Sidebar className="h-full w-[200px]">
            <SidebarContent>
        ...
        {/* Main content */}
        <div className="flex-1 flex flex-col ml-[200px] transition-[margin] duration-300 ease-in-out data-[collapsed=true]:ml-[64px] w-[calc(100%-200px)]">
